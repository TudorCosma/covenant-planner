    ...
    <div className={`flex flex-col gap-1 ${className}`}>
      ...
      <div className="flex items-center" style={{ background: COLORS.inputBg, border: `1px solid ${COLORS.inputBorder}`, borderRadius: 6, overflow: "hidden", boxShadow: "inset 0 1px 2px rgba(0,0,0,0.06)" }}>
        ...
        <input
          ...
          onBlur={handleBlur}
          style={{
            background: "transparent", border: "none", outline: "none", color: COLORS.inputText || COLORS.text, padding: prefix ? "6px 10px 6px 4px" : "6px 10px",
            fontSize: 13, width: "100%", fontFamily: "'JetBrains Mono', monospace",
          }}
          {...props}
        />
...
// DASHBOARD TAB
// ============================================================
function DashboardTab({ state, projectionData, afterProjectionData, afterState, scenario }) {
  ...
  const [chartPopup, setChartPopup] = useState(null); // null | "incomeVsExp" | "assetBreakdown" | "agePension"
  ...
  return (
    <div style={{ background: COLORS.bg, minHeight: "100vh", color: COLORS.text, fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "20px 20px 60px" }}>
        {tab === "dashboard" && <DashboardTab state={state} projectionData={projectionData} afterProjectionData={afterProjectionData} afterState={afterState} scenario={scenario} />}

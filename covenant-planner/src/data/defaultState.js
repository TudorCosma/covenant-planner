...
export const DEFAULT_STATE = {
  ...
  wizardCompleted: false,           // true once the user finishes (or skips) the first-run wizard

  // ----- User-set goals (V2). Array of typed goal objects; one progress bar per goal. -----
  // See src/lib/goalProgress.js for the GOAL_KINDS catalogue and per-kind calculators.
  goals: [],
